...
//允許的網址格式
$kdao_only=0;
if(preg_match("%2cat\.or\.tl%U",$url))
{$kdao_only=1;}
...
if(!$kdao_only){//只使用於綜合網址
	...
	$pattern="%</small><br /><a href=\"(http://2cat\.or\.tl/~tedc21thc/live/src/[0-9]{13}\.[a-z]{3})%U";
	...
	$htmlbody.="<br/>\n";
	foreach($matches_a[1] as $k => $v){//自動型轉向迴圈式
...
綜合網址<input type="text" name="input_a" size="20" value="$input_a"><input type="submit" value=" send "><br/>
